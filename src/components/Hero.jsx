    ...
    <div className="w-full h-[100vh] flex items-center justify-center" style={{ backgroundColor: '#f3eee5' }}>
      <div className="container mx-auto max-w-7xl px-6 sm:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-6 flex flex-col items-center text-center transform -translate-y-10"> {/* Shifted upward */}
            <div className="mb-8">
          ...
          {/* Right side with balance scale */}
          <div className="lg:col-span-6 flex justify-center">
            <div ref={balanceRef} className="relative w-[380px] h-[380px]">
              {/* Background circle */}
              <div className="absolute w-[350px] h-[350px] rounded-full border-8 border-[#251c1a]/10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"></div>
              
              {/* Central pole */}
              <div className="absolute left-1/2 top-[15%] h-[70%] w-6 bg-[#251c1a] rounded-t-full transform -translate-x-1/2">
                <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-14 h-14 rounded-full bg-[#251c1a] flex items-center justify-center">
                  <FaGavel className="text-[#f3eee5] text-xl" />
                </div>
                
                <div className="absolute w-20 h-20 rounded-full border-4 border-[#251c1a]/20 top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 animate-ping opacity-30"></div>
              </div>
              
              {/* The balance beam */}
              <div className={`absolute top-[30%] left-1/2 w-[320px] h-6 bg-gradient-to-r from-[#251c1a] via-[#3a2e2b] to-[#251c1a] rounded-full transform -translate-x-1/2 origin-center transition-transform duration-1000 ${
                isBalanced ? 'rotate-0' : 'rotate-[5deg]'
              }`}>
                {/* Left scale plate */}
                <div className={`absolute left-0 -bottom-[140px] w-[120px] h-[120px] rounded-full border-8 border-[#251c1a] transition-transform duration-1000 ${
                  ...
                  <div className="absolute inset-0 flex items-center justify-center flex-col">
                    <div className="text-[#251c1a] text-3xl font-bold">LAW</div>
                    <div className="text-xs text-[#251c1a]/70 mt-1">§ Precedent</div>
                  </div>
                </div>
                
                {/* Right scale plate */}
                <div className={`absolute right-0 -bottom-[140px] w-[120px] h-[120px] rounded-full border-8 border-[#251c1a] transition-transform duration-1000 ${
                  isBalanced ? 'transform -translate-y-4' : ''
                }`}>
                  <div className="absolute inset-0 rounded-full bg-[#251c1a]/5 backdrop-blur-sm"></div>
                  ...
                  {/* Logic symbol */}
                  <div className="absolute inset-0 flex items-center justify-center flex-col">
                    <div className="text-[#251c1a] text-3xl font-bold">LOGIC</div>
              ...
              {/* Decorative patterns */}
              <svg className="absolute top-0 right-0 w-24 h-24 text-[#251c1a]/10" viewBox="0 0 100 100">
                <path fill="currentColor" d="M0,0 L100,0 L100,100 Z" />
              </svg>
              <svg className="absolute bottom-0 left-0 w-24 h-24 text-[#251c1a]/10" viewBox="0 0 100 100">
